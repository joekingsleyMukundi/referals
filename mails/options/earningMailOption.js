const earningOption = (email,fullname,earning)=>{
    let options = {
        ...
        to: email,
        subject: "Earnings",
        html:  `<p><b>Congratulations ${fullname}</b><br> You have earned ${earning},today  and  the details are as follows <br>
        Transaction Code : ${transactionid}.<br> Amount Earned : ${earning}.<br> Login to your account  and confirm this transaction: <br>
